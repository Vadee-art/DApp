...
export const useGetRelatedArtworks = (
  params: GetRelatedArtworksParams,
  options?: Omit<
    UseQueryOptions<GetRelatedArtworksResponse, string, GetRelatedArtworksResponse>,
    'queryKey' | 'queryFn'
  >
) => {
  return useQuery<GetRelatedArtworksResponse, string>(
    ['related-artworks', params],
    () => getRelatedArtworks(params),
    { ...options }
  );
};
