...
export const ArtworksFilterForm = ({filters, onChange, filtersToDisplay = ['category', 'origin', 'sub_category'], defaultValue}: Props) => {

  const [selectedFilters, setSelectedFilters] = useState<ArtworksFilters>(defaultValue || {
    category: [],
    sub_category: [],
    origin: [],
  });
